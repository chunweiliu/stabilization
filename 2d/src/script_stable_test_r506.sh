...
#for para in 1e-3 1e-2 1e-1 1e0 1e1 1e2 1e3
#for para in 1e0 1e1 1e2
#for para in 3e0 5e0 7e0 9e0
#for para in 1e-1 3e-1 5e-1 7e-1 9e-1 1e0 3e0 5e0 7e0 9e0 1e1 3e1 5e1 7e1 9e1
for para in 1e-4 3e-4 5e-4 7e-4 9e-4 1e-3 3e-3 5e-3 7e-3 9e-3 1e-2 3e-2 5e-2 7e-2 9e-2
do
	...
	if [ ! -f "$out_file" ]; then
	    echo "../bin/draw_tracks $image_dir1 $tracks_file1 $path_file1 $draw_tracks_file1 $draw_smooth_file1 $draw_tracks_len"
	    ../bin/draw_tracks $image_dir1 $tracks_file1 $path_file1 $draw_tracks_file1 $draw_smooth_file1 $draw_tracks_len
	fi
	...
	if [ ! -f "$out_file" ]; then
	    echo "../bin/draw_tracks $image_dir2 $tracks_file2 $path_file2 $draw_tracks_file2 $draw_smooth_file2 $draw_tracks_len"
	    ../bin/draw_tracks $image_dir2 $tracks_file2 $path_file2 $draw_tracks_file2 $draw_smooth_file2 $draw_tracks_len
	fi
