...
tracks_dir=../log/txt/tracks_fund_mat/
...
echo "../bin/sift_fund_match $key_dir1 $key_dir2 $fund_key_dir1 $fund_key_dir2 $fund_mat_dir"
../bin/sift_fund_match $key_dir1 $key_dir2 $fund_key_dir1 $fund_key_dir2 $fund_mat_dir
